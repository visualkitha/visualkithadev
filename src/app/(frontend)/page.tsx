    ...
    <div className="flex flex-col">
      ...
      <section className="relative w-full py-20 md:py-32 lg:py-40 flex items-center justify-center text-center text-white">
          <video
            ...
            src="https://videos.pexels.com/video-files/853765/853765-hd_1920_1080_25fps.mp4"
          >
            <source src="https://videos.pexels.com/video-files/853765/853765-hd_1920_1080_25fps.mp4" type="video/mp4" />
